...
- Si el número en lista_a es mayor, su valor de la diferencia se suma al siguiente número en lista_a.
- Si el número en lista_b es mayor, su valor de la diferencia se suma al siguiente número en lista_b.
